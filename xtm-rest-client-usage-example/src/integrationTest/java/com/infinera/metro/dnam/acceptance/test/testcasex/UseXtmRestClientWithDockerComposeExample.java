...
//        final DockerCompose dockerCompose = objectFromFileUtil.getObject("dockercompose/three-nodes-example-docker-compose-rule/docker-compose.yml", DockerCompose.class);
...
//
//        nodeAccessDataNodeA = objectFromFileUtil.getObject("dockercompose/three-nodes-example-docker-compose-rule/node_a_access_data.yaml", NodeAccessData.class)
//                .copyObjectAndChangeIpAddress(dockerComposeIpAddressNodeA);
//        nodeEquipmentNodeA = objectFromFileUtil.getObject("dockercompose/three-nodes-example-docker-compose-rule/node_a_equipment.yaml_old", NodeEquipment.class);
//
...
//        nodeAccessDataNodeZ = objectFromFileUtil.getObject("dockercompose/three-nodes-example-docker-compose-rule/node_z_access_data.yaml", NodeAccessData.class)
//                .copyObjectAndChangeIpAddress(dockerComposeIpAddressNodeZ);
//        nodeEquipmentNodeZ = objectFromFileUtil.getObject("dockercompose/three-nodes-example-docker-compose-rule/node_z_equipment.yaml", NodeEquipment.class);
//    }
//
