...
//        nodeAccessDataNodeZ = objectFromFileUtil.getObject("dockercompose/test-case-x-node-config/node_z_access_data.yaml", NodeAccessData.class)
//                .copyObjectAndChangeIpAddress(dockerComposeIpAddressNodeZ);
//        nodeEquipmentNodeZ = objectFromFileUtil.getObject("dockercompose/test-case-x-node-config/node_z_equipment.yaml", NodeEquipment.class);
//    }
//
